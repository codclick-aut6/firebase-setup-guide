  ...
  return (
    <div style={{ backgroundColor: settings.cor_background, color: settings.cor_fonte, minHeight: '100vh' }}>
      ...
      {(() => {
        ...
        return (
          <div className="w-full bg-white px-4 pt-1 pb-3 border-b border-muted/40 -mt-1 md:mt-0 relative z-10">
            {isLongo ? (
              // Banner longo: ocupa a largura dos dois banners + espaçamento,
              // mantendo a mesma proporção 2:1 dos banners normais (mais alto)
      ...
      {/* BUSCA MOBILE */}
      <div className="order-1 md:order-3 px-4 z-10 mt-3 flex md:hidden mb-2">
