        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label>Cor de Destaque da Categoria Ativa</Label>
                <div className="flex items-center gap-2 mt-1">
                  <input type="color" value={corDestaqueCategoriaAtiva} onChange={(e) => setCorDestaqueCategoriaAtiva(e.target.value)} className="w-10 h-10 rounded cursor-pointer border-0" />
                  <Input value={corDestaqueCategoriaAtiva} onChange={(e) => setCorDestaqueCategoriaAtiva(e.target.value)} className="flex-1" />
                </div>
              </div>
              <div>
                <Label>Cor da Fonte da Categoria Ativa</Label>
                <div className="flex items-center gap-2 mt-1">
                  <input type="color" value={corFonteCategoriaAtiva} onChange={(e) => setCorFonteCategoriaAtiva(e.target.value)} className="w-10 h-10 rounded cursor-pointer border-0" />
                  <Input value={corFonteCategoriaAtiva} onChange={(e) => setCorFonteCategoriaAtiva(e.target.value)} className="flex-1" />
                </div>
              </div>
              <div>
