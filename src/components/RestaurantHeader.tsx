...
const RestaurantHeader: React.FC<RestaurantHeaderProps> = ({ actions, onBannerClick }) => {
  ...
  return (
    <div className="relative">
      {/* Esconde o banner principal no mobile */}
      <div
        className={`hidden md:block h-44 sm:h-72 w-full overflow-hidden ${onBannerClick ? "cursor-pointer" : ""}`}
      ...
      {/* Container principal */}
      <div className="container mx-auto px-0 md:px-4 relative mt-0 md:-mt-[7rem] z-10">
        <div
